...
import './VirtualCardDetails.css';
import logo from '../../assets/swipe_card_black.png';

const VirtualCardDetails: React.FC = () => {
      ...
      <div className="card-details-container">
        <div className="card-details-card">
          ...
          <div className="card-detail-field">
            <label style={{ color: "#5CAEA2" }}>Card Number</label>
          ...
          <div className="card-detail-field">
            <label style={{ color: "#5CAEA2" }}>Expiration Date</label>
            <div className="detail-value-container">
          ...
          <div className="card-detail-field">
            <label style={{ color: "#5CAEA2" }}>Security Code</label>
            <div className="detail-value-container">
